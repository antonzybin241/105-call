    ...
    <div className="min-h-screen bg-[#0A0E27] text-white overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          >
            <ConnectWalletButton userId="sousa" />
            <button className="flex items-center gap-2 px-8 py-3 rounded-xl text-base font-medium text-gray-300 bg-white/[0.04] border border-white/[0.08] hover:bg-white/[0.08] hover:border-white/[0.12] transition-all">
              <Eye size={18} />
              View Demo
            </button>
          </div>
